...
set TTS_QUALITY=BALANCED
set COQUI_TTS_VERBOSE=false
...
set SSL_KEY_STORE=classpath:your-keystore.p12
set SSL_KEY_STORE_PASSWORD=YOUR_KEYSTORE_PASSWORD
set SSL_KEY_ALIAS=your-key-alias
