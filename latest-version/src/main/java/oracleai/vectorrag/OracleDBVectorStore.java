...
import oracleai.vectorrag.model.VectorData;
...
public class OracleDBVectorStore implements VectorStore, InitializingBean {
    ...
    @Value("${vectorrag.table-name:vectorrag_table}")
    ...
    @Value("${vectorrag.drop-at-startup:false}")
    private Boolean dropAtStartup;

    @Value("${vectorrag.distance-metric:COSINE}")
