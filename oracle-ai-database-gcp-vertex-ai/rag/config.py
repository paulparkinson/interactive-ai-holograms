...
PROJECT_ID = os.environ.get("GOOGLE_CLOUD_PROJECT", "your-project-id")  # Replace with your project ID
LOCATION = os.environ.get("GOOGLE_CLOUD_LOCATION", "us-central1")  # Default location for Vertex AI resources
...
# Logging Settings
LOG_LEVEL = "INFO"
LOG_FORMAT = "%(asctime)s - %(name)s - %(levelname)s - %(message)ss
LOG_LEVEL = "INFO" 